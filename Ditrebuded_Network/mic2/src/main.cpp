...
//
// Same shape as mic1/ -- two build configurations selected by
...
//                           Sends InferencePacket (74 bytes) to coordinator.
//
//   USE_HASH_KWS_MODEL=1  - real inference.  Pulls audio_provider /
//                           feature_provider / hash_kws_runtime via
//                           lib_extra_dirs from
//                           Моедли/board2_model_9261_node2/.
//
// See mic1/src/main.cpp for the list of issues fixed compared to the
// reference micro_speech.ino sketch.

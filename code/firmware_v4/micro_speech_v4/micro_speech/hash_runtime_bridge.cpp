...
// v4: in-tree model export (self-contained; was the stale code/training/ shim).
// The active runtime's hash_model_data.cpp is swapped per variant by
// select_hash_kws_variant_v4.ps1, matching sibling includes 20/23/24/25.
#include "../../hash_kws_runtime/hash_model_data.cpp"
